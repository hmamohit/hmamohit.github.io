...
│   └── 📂 content/: editable Markdown content for pages
  │   └── 📄 resume.md: Resume page content in Markdown
├── 📂 _bibliography/
...
## Modifying the Resume information

The resume page now uses Markdown as the source of truth. Edit [assets/content/resume.md](assets/content/resume.md) to update all resume sections.
